...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_AUDIO] = LAYOUT(KC_VOLD, KC_VOLU, KC_DOWN, KC_UP,   MODECON, KC_ENT,  LT(_HUE, KC_MPRV), LT(_SAT, KC_MPLY), LT(_VAL, KC_MNXT), LT(_MODE, KC_SPC)),
    [_HUE]   = LAYOUT(RGBNHUD, RGBNHUI, KC_DOWN, KC_UP,   RGB_TOG, RGBRST,  CK_TOGG, _______, RGBNHUD, RGBNHUI),
