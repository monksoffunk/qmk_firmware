    ...
    */
    ...
    #define __________DEFAULT_1__________   ENC_00,  KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,    KC_8,    KC_9,   KC_0,   KC_MINS
    ...
    #define ___________LOWER_1___________   ENC_01,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, S(KC_MINS)
    ...
    #define ___________LOWER_5___________   _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT
        ...
        * `-----------------------------------------------------------'
        */
    #define ___________RAISE_1___________   ENC_02,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ...
    #define ___________RAISE_5___________   _______, _______, _______, _______, _______, _______, _______, _______
        ...
        /* Adjust Layer
        * ,-----------------------------------------------------------.
        * |EN03| F1 | F2 | F3 | F4 | F5 | F6 | F7 | F8 | F9 | F10| F11|
        * |-----------------------------------------------------------|
        * |    | F11| F12|    |    |    |    |    |    |    |    |    |
        * |-----------------------------------------------------------|
        ...
        * `-----------------------------------------------------------'
        */
    #define __________ADJUST_1___________   ENC_03,  KC_F1,   KC_F2,  KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  ENC_13
    ...
    #else
    #define __________ENCADJ_3___________   _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    #endif
