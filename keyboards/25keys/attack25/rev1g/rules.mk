...
define ATTACK25_CUSTOMISE_MSG
	...
	$(info -  ENCODER=$(ENCODER_MATRIX_ENABLE))
endef
...
ENCODER_MATRIX_ENABLE = no         # Enable Encoder
...
ifneq ($(strip $(ATTACK25)),)
	...
	ifeq ($(findstring encoder,$(ATTACK25)), encoder)
    	ENCODER_MATRIX_ENABLE = yes
  	endif
...
ifeq ($(strip $(ENCODER_MATRIX_ENABLE)), yes)
    OPT_DEFS += -DENCODER_MATRIX_ENABLE
	SRC += ../common/encoder_action.c
	SRC += ../common/encoder_matrix.c
	SRC += ../common/sym_eager_encoder_pk.c
	DEBOUNCE_TYPE = custom   #sym_eager_pk
endif
