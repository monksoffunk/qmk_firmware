...
enum attack25_user_keycodes {
    MICC80D = USR_SAFE_RANGE,
    MICC81D,
    MICC82D,
    MICC83D,
    MICC84D,
...
#    define __________NUM_E0_________   MICC80D,    MICC80I
#    define __________NUM_E1_________   MICC81D,    MICC81I
#    define __________NUM_E2_________   MICC82D,    MICC82I
#    define __________NUM_E3_________   MICC83D,    MICC83I
#    define __________NUM_E4_________   MICC84D,    MICC84I
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
   // static uint16_t presstime;
    switch (keycode) {
        ...
        case MICC84D:
        case MICC85D:
            midi_send_cc(&midi_device, MIDI_CH, keycode - MICC80D, 63);
            return false;
            break;
        ...
        case MICC84I:
        case MICC85I:
            midi_send_cc(&midi_device, MIDI_CH, keycode - MICC80I, 65);
            return false;
            break;
    }
    return true;
