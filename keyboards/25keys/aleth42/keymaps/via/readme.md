...
CHENCR0 to change ENCODER_RESOLUTION of Left Encoder (4 > 1 > 2 > 4 > 1...)
CHENCR1 to change ENCODER_RESOLUTION of Right Encoder (4 > 1 > 2 > 4 > 1...)

LK00 - LK13 to Lock layer for encoder on default layer
