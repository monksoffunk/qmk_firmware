...
/* key matrix pins */
#ifdef ENCODER_ENABLE
#define MATRIX_ROW_PINS { GP3, GP6, GP15, GP20, NO_PIN }
//#define MATRIX_ROW_PINS { B4, B0, B2, B1, NO_PIN }
#else
#define MATRIX_ROW_PINS { GP3, GP6, GP15, GP20 }
#endif
//#define MATRIX_COL_PINS { D5, D3, D2, D1, D0, D6, D4, F7, F0, F1, F4 }
#define MATRIX_COL_PINS { GP2, GP19, GP18, GP17, GP16, GP5, GP4, GP8, GP14, GP13, GP12 }
#define UNUSED_PINS
...
# define ENCODERS_PAD_A { GP0, GP9 }
# define ENCODERS_PAD_B { GP1, GP10 }
